function MandelbrotBW

%%% Compute and draw the Mandelbrot set (black/white version)
...
niter=40;               % number of iterations (default: 23)
...
for k = 1:niter
    ...
    C = abs(Zn)<th;   % if |Zn| > th the sequence diverges
end
